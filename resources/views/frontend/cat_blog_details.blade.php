            ...
            <div class="row justify-content-center">
                <div class="col-xl-6 col-lg-8 col-md-10">
                    <div class="breadcrumb__wrap__content">
                        <h2 class="title">{{ $categoryInfo->blog_category }}</h2>
                        ...
                        <div class="standard__blog__post">
                            <div class="standard__blog__thumb">
                                <a href="{{ route('blog.details', $blog->id) }}"><img
                                        src="{{ asset('upload/' . $blog->blog_image) }}" width="650" height="330"
                                        alt=""></a>
                            ...
                            <div class="standard__blog__content">
                                <div class="blog__post__avatar">
                                    <div class="thumb"><img src="{{ asset('upload/' . $blog->blog_image) }}"
                                            alt=""></div>
                                    <span class="post__by">By : <a
                                            href="#">{{ $blog->category->blog_category }}</a></span>
                                </div>
                                <h2 class="title"><a
