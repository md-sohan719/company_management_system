            ...
            <div class="row align-items-center justify-content-center justify-content-lg-between">
                <div class="col-lg-6 order-0 order-lg-2">
                    <div class="banner__img text-center text-xxl-end">
                        <img src="{{ asset('upload/' . $homeSlide->home_slide) }}" alt="">
                    </div>
                </div>
    ...
    <section id="aboutSection" class="about">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <ul class="about__icons__wrap">
                        @foreach ($allMultiImage as $multiImage)
                            <li>
                                <img class="light" src="{{ asset('upload/' . $multiImage->image_path) }}" alt="XD">
                            </li>
                        @endforeach
                    </ul>
                </div>
                <div class="col-lg-6">
                    @php
                        $aboutInfo = App\Models\About::find(1);
                    @endphp
                                ...
                                @foreach ($allPortfolio as $portfolio)
                                    <div class="portfolio__item">
                                        <div class="portfolio__thumb">
                                            <img src="{{ asset('upload/' . $portfolio->portfolio_image) }}"
                                                alt="" width="1020" height="520">
                                        </div>
                                        <div class="portfolio__overlay__content">
                                            <span>{{ $portfolio->portfolio_name }}</span>
                                            <h4 class="title"><a
                                                    href="portfolio-details.html">{{ $portfolio->portfolio_title }}</a>
                                            </h4>
